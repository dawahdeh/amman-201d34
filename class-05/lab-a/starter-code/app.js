...
and then returns an array where the first element is the sum of
 those numbers, and the second element is a concatenated string that 
 EXACTLY follows this example and uses the values that were input 
 into the function:
...
function, and to do multiplication, use your multiply() function that you've already created.
...
let product1=1;
 ...
 product1=multiply(a, b);
let product =multiply(product1[0], c);
...
and the second element is a string that EXACTLY follows this example and uses the values that 
...
let Total1 =sum(testArray[0],testArray[1]);
let Total=sum(Total1[0],testArray[2]);
